...
\begin{exercise}[$k$-Nearest Neighbours (5 pts)]
  The KNN-dataset provides a 4x4 representation of the handwritten digits 5, 6, and 8. Using the notebook provided \red{(updated February 8)}, train a KNN classifier using 5-fold cross validation to determine the optimal k-value for this task.

  \red{
  February 8 changes include:
  \begin{itemize}
    \item Clarifying that Euclidean distance should be used (also mentioned in Piazza)
    \item Fixing the summary of the predict\_knn function. It contained a mistake that suggested using the labels of the data you want to predict, instead of the labels of the training (neighbours) data (also mentioned in Piazza).
  \end{itemize}
  }
...
Discuss similarities and differences between the solution obtained via these \red{two working} methods. 
...
Based on your answer to these questions, sketch a 2D caricature of what the points and the hyperplane defined by the SVM solution look like.
    \red{A ``caricature'' in this context means a rough sketch of what you think Mystery Dataset Alooks like, using the information you have learned in this question and the previous part. 
...
\item (3 pts) Implement \Cref{alg:CSVM}. You should use Ex \red{4.2} to complete lines 5-6, and Ex \red{4.3} for line 7. 
