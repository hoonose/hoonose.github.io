...
\lfoot{}
\cfoot{\textbf{Gautam Kamath (gckamath@uwaterloo.ca) \textcopyright 2025}}
...
\begin{center}
\large{\textbf{CS480/680: Introduction to Machine Learning} \\ Homework 3\\ Due: 11:59 pm, November 14, 2025, submit on LEARN and CrowdMark.} \\
...
\begin{exercise}[CNN Implementation (8 pts)]
  ...
  \begin{enumerate}[label=\alph*)]
    \item Train a VGG11 net on the MNIST dataset (which should be loadable via, e.g., torchvision). 
